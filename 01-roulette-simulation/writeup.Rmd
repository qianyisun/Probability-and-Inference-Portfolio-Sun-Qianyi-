...
plot(earnings,type="l",xlab="wager number")
```
## Question 2
...
plot(x=xb,y=store_outmoney,type="l",xlab="Starting budget") #draw a line chart
```
#### Figure analysis for changing B value
When X within walk_out_money<-rep(NA,X) is growing, then the plot will show Starting budget and store_outmoney has positive relation.
...
plot(x=xw,y=store_outmoney,type="l",xlab="the budget threshold for successfully stoping")#draw a line chart
```
#### Figure analysis for changing W value
Then the plot will show the budget threshold for successfully stoping and store_outmoney has negative relation.
...
plot(x=xl,y=store_outmoney,type="l",xlab="the maximum number of plays")#draw a line chart
```
#### Figure analysis for changing L value
The maximum number of plays and store_outmoney do not have distinct relation.
...
plot(x=xm,y=store_outmoney,type="l",xlab="the casino wager limit")#draw a line chart
```
#### Figure analysis for changing M value
The casino wager limit and store_outmoney do not have distinct relation.
