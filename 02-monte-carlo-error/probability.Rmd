...
plot(ae1_log10_scale,type="b",xlim=c(0,15),ylim=c(-3.5,-0.5), xlab="N(log2 scale)",ylab="Absolute Error_log10_scale",xaxt="n")
...
plot(re1_log10_scale,type="b",xlim=c(0,15),ylim=c(-3,0.5), xaxt="n",xlab="N(log2 scale)",ylab="Relative Error_log10_scale")
