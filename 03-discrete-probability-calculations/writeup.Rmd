...
plot(x=p2,y=Braves_win2,xlab="Probability of the Braves winning a head-to-head matchup",ylab="P(Win World Series)",main="Probability of winning the World Series",ylim=c(0,1),xlim=c(0.47,1.03),type="l")
...
plot(x=p_braves_win4_total,y=pr,xlim=c(0.47,1.03),xlab="Probability of the Braves winning a head-to-head matchup",ylab="Series length",type="l",main="Shortest series so that P(Win MS given p)")
```
...
$=\frac{P(P_B=0.55)}{P(P_B=0.55)+P(P_B=0.45)}$
